...
const form = useForm({
    name: '', description: '',
    unit_price: '', unit: 'unité',
    vat_rate: '20.00', is_active: true,
})
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-xl font-semibold text-gray-800">Nouveau produit / Новий товар</h2>
            </div>
        </template>
        ...
        <div class="py-8 max-w-2xl mx-auto px-4">
            <form @submit.prevent="submit" class="bg-white rounded-xl shadow p-8 space-y-5">
                <div>
                    <InputLabel for="name" value="Nom / Назва *" />
                    <TextInput id="name" v-model="form.name" type="text" class="mt-1 block w-full" required />
                    <InputError class="mt-1" :message="form.errors.name" />
                </div>
                <div>
                    <InputLabel for="description" value="Description / Опис" />
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        <InputLabel for="unit_price" value="Prix HT / Ціна *" />
                    ...
                    <div>
                        <InputLabel for="unit" value="Unité / Одиниця *" />
                    ...
                    <div>
                        <InputLabel for="vat_rate" value="TVA % / ПДВ % *" />
                ...
                <div class="flex items-center gap-2">
                    ...
                    <InputLabel for="is_active" value="Actif / Активний" class="mb-0" />
                </div>
